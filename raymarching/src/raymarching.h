...
void composite_rays_train_backward(at::Tensor grad_img, at::Tensor grad_A,at::Tensor sigmas, at::Tensor rgbs, at::Tensor deltas, at::Tensor rays, at::Tensor image,at::Tensor A, const float bound, const uint32_t M, const uint32_t N, at::Tensor grad_sigmas, at::Tensor grad_rgbs);
